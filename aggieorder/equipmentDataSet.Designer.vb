...
Partial Public Class equipmentDataSet
    ...
    Partial Public Class EquipmentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddEquipmentRow(ByVal Name As String, ByVal Price As Integer, ByVal Description As String, ByVal Image As String) As EquipmentRow
            Dim rowEquipmentRow As EquipmentRow = CType(Me.NewRow,EquipmentRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Name, Price, Description, Image}
    ...
    Partial Public Class EquipmentRow
        ...
        Public Property Price() As Integer
            Get
                Try 
                    Return CType(Me(Me.tableEquipment.PriceColumn),Integer)
                Catch e As Global.System.InvalidCastException
        ...
        Public Function IsImageNull() As Boolean
            Return Me.IsNull(Me.tableEquipment.ImageColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Sub SetImageNull()
            Me(Me.tableEquipment.ImageColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace equipmentDataSetTableAdapters
    ...
    Partial Public Class EquipmentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Equipment` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Na"& _ 
                "me` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Im"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Equipment` (`Name`, `Price`, `Description`, `Image`) VALUES (?, ?, ?"& _ 
                ", ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Equipment` SET `Name` = ?, `Price` = ?, `Description` = ?, `Image` = ? WH"& _ 
                "ERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND"& _ 
                " `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Image` IS NULL) OR (`Image`"& _ 
                " = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.aggieorder.My.MySettings.Default.equipmentConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Name, Price, Description, [Image] FROM Equipment"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Name As String, ByVal Original_Price As Global.System.Nullable(Of Integer), ByVal Original_Image As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal Price As Global.System.Nullable(Of Integer), ByVal Description As String, ByVal Image As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal Price As Global.System.Nullable(Of Integer), ByVal Description As String, ByVal Image As String, ByVal Original_ID As Integer, ByVal Original_Name As String, ByVal Original_Price As Global.System.Nullable(Of Integer), ByVal Original_Image As String) As Integer
            If (Name Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_Image,String)
            End If
